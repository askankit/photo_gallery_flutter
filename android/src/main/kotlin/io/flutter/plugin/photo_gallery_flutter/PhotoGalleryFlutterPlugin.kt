...
/** PhotoGalleryFlutterPlugin */
class PhotoGalleryFlutterPlugin : FlutterPlugin, MethodCallHandler, ActivityAware {
  companion object {
    ...
    fun registerWith(registrar: Registrar) {
      val channel = MethodChannel(registrar.messenger(), "photo_gallery_flutter")
      val plugin = PhotoGalleryFlutterPlugin()
  ...
  override fun onAttachedToEngine(flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "photo_gallery_flutter")
    val plugin = this
  ...
  private fun getCachePath(): File {
    return this.context.run {
      val cachePath = File(this.cacheDir, "photo_gallery_flutter")
      if (!cachePath.exists()) {
        cachePath.mkdirs()
      }
