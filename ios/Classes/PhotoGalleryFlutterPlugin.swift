...
public class PhotoGalleryFlutterPlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "photo_gallery_flutter", binaryMessenger: registrar.messenger())
    let instance = PhotoGalleryFlutterPlugin()
  ...
  private func listAlbums(mediumType: String?, hideIfEmpty: Bool? = true) -> [[String: Any?]] {
      ...
      func addCollection(collection: PHAssetCollection, hideIfEmpty: Bool) {
          // Skip recently deleted and duplicates
      ...
      func processPHAssetCollections(fetchResult: PHFetchResult<PHAssetCollection>, hideIfEmpty: Bool) {
          fetchResult.enumerateObjects { (collection, _, _) in
              addCollection(collection: collection, hideIfEmpty: hideIfEmpty)
          }
      }
